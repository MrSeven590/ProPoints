...
- `PHASE2_IMPLEMENTATION_GUIDE.md`：Phase 2 核心数据流强类型化的历史执行计划 / 背景资料；其中分步清单不再作为当前待办逐项执行。
- `PHASE3_COMMIT_SPLIT_PLAN.md`：Phase 3 三个组件边界 typed 化的历史 commit 切分资料；当前以代码复核结果和本文第 3 轮准入条件为准。
